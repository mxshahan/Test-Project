...
const TrainingHistory = () => (
    <div class="pv-40 footer-top">
        <div class="container">
            ...
            <div class="row mb-20">
                <div class="col-lg-6"><img src="images/education-about.jpg" alt=""/></div>
                <div class="col-lg-6">
                    <h3 class="logo-font">Training <span class="text-default">Academy </span> Since <span class="text-default">1990</span></h3>
